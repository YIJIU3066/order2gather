...
const mockFriends = [
    {name: 'Walter', gmail: "chemistryisart@gmail.com", groups: [{name: "Cook", id: 1}, {name: "Teacher", id: 2}, {name: "Boss", id: 3}], checked: false, id: 1},
    {name: 'Jesse', gmail: "yoyoyo@gmail.com", groups: [{name: "Cook", id: 1}, {name: "Gang", id: 4}], checked: false, id: 2},
    {name: 'Gus', gmail: "lospoloshermanos@gmail.com", groups: [{name: "Boss", id: 3}, {name: "Chicken", id: 5}], checked: false, id: 3},
    {name: 'Skyler', gmail: "mynameisskylerwhiteyo@gmail.com", groups: [], checked: false, id: 4},
    {name: 'Saul', gmail: "bettercallsaul@gmail.com", groups: [{name: "Lawyer", id: 6}], checked: false, id: 5},
    {name: 'Hank', gmail: "coolmineral@gmail.com", groups: [{name: "DEA", id: 7}], checked: false, id: 6},
    {name: 'Mike', gmail: "waltuh@gmail.com", groups: [{name: "Chicken", id: 5}], checked: false, id: 7},
]
...
export default function GroupList() {
    ...
    const addGroup = ({ groupName, friend }) => {
        groupList.push({name: groupName, id: mockGroups.length + 1, checked: false})
        for (let i = 0; i < friend.length; i++) {
            for (let j = 0; j < mockFriends.length; j++) {
                if (mockFriends[j].name === friend[i].name) {
                    mockFriends[j].groups.push({name: groupName, id: mockGroups.length})
                    break;
                } 
            }
        }
    ...
    return (
        ...
        <div className="flex flex-col justify-center items-center">
            ...
            <div className="w-full grid grid-cols-5 gap-2 px-[10vw] justify-items-center items-center">
                ...
                <div></div>
                <ListNav showIndex={showGroups} setShowIndex={setShowGroups} len={groupList.length}/>                    
            </div>  
        </div>
        {addOpen && (
            <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50 duration-100">
                <AddGroupForm friends={mockFriends} setAddOpen={setAddOpen} addGroup={addGroup}/>
            </div>
        )}
    </>
  )

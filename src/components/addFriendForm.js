    ...
    <div className="w-full h-full flex justify-center items-center">
        <div className="md:w-1/3 sm:w-2/3 border-8 border-blue p-4 rounded shadow flex flex-col items-center bg-slate-50 relative">
            <div className="grid grid-cols-3 w-4/5 gap-3 my-4 items-center">
                <h2 className="text-2xl text-blue font-bold my-2 mr-auto col-span-2">Add Friend</h2>
                ...
                <input value={gmail} onChange={(e) => setGmail(e.target.value)} placeholder="e.g. amy@gmail.com" type="text" className="rounded-md focus:border-blue border-2 border-solid focus:outline-none focus:ring-0 bg-slate-50 col-span-2 text-grey p-1" />
